game.Players.LocalPlayer.OnTeleport:Connect(function(state)
    if state == Enum.TeleportState.Started then
        (syn and syn.queue_on_teleport or queue_on_teleport)("loadstring(game:HttpGet('https://raw.githubusercontent.com/ForcedProject/FARAIZUUUU/main/cockandballz.lua'))()")
    end
end)
if game:IsLoaded() then
    wait(10)
    local jefaoui = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart.CFrame")
